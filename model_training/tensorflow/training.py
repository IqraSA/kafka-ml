...
def load_environment_vars(case):
  ...
  if case == NOT_DISTRIBUTED_NOT_INCREMENTAL:
    ...
    return (bootstrap_servers, result_url, result_id, control_topic, deployment_id, optimizer, learning_rate, loss, metrics, batch, kwargs_fit, kwargs_val, confussion_matrix, stream_timeout, message_poll_timeout, monitoring_metric, change, improvement, numeratorBatch, denominatorBatch, N)
...
if __name__ == '__main__':
  try:
    ...
    if case == NOT_DISTRIBUTED_NOT_INCREMENTAL:
      ...
      bootstrap_servers, result_url, result_id, control_topic, deployment_id, optimizer, learning_rate, loss, metrics, batch, kwargs_fit, kwargs_val, confussion_matrix, stream_timeout, message_poll_timeout, monitoring_metric, change, improvement, numeratorBatch, denominatorBatch, N = load_environment_vars(case)
